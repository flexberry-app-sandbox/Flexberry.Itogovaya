...
namespace IIS.Itogovaya
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itogovaya.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Itogovaya.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Itogovaya.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Itogovaya.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itogovaya.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Itogovaya.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Itogovaya.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Itogovaya.План this[int index]
        {
            get
            {
                return ((IIS.Itogovaya.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itogovaya.План dataobject)
        {
