...
namespace IIS.Itogovaya
{
    ...
    public class ОтчетОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya.СостОплаты fСостояниеОплаты;
        
        private IIS.Itogovaya.СостОтгрузки fСостОтгрузки;
        ...
        private IIS.Itogovaya.Контрагенты fКонтрагенты;
        
        private IIS.Itogovaya.Организации fОрганизации;
        
        private IIS.Itogovaya.Склады fСклады;
        
        private IIS.Itogovaya.DetailArrayOfТЧЗаказ fТЧЗаказ;
        ...
        public virtual IIS.Itogovaya.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.Itogovaya.СостОтгрузки result = this.fСостОтгрузки;
        ...
        public virtual IIS.Itogovaya.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.Itogovaya.СостОплаты result = this.fСостояниеОплаты;
        ...
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        [NotNull()]
        public virtual IIS.Itogovaya.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.Itogovaya.Контрагенты result = this.fКонтрагенты;
        ...
        public virtual IIS.Itogovaya.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                {
                    this.fТЧЗаказ = new IIS.Itogovaya.DetailArrayOfТЧЗаказ(this);
                }
                IIS.Itogovaya.DetailArrayOfТЧЗаказ result = this.fТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакE", typeof(IIS.Itogovaya.ОтчетОЗак));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакL", typeof(IIS.Itogovaya.ОтчетОЗак));
                }
            }
        }
    }
