...
namespace IIS.Itogovaya
{
    ...
    [View("ЗаказПостL", new string[] {
            ...
            "Организации.Организация as \'Организация\'",
            "Контрагенты.Контрагент as \'Контрагент\'"})]
    public class ЗаказПост : IIS.Itogovaya.ОтчетОЗак
    {
        ...
        public override IIS.Itogovaya.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.Itogovaya.СостОтгрузки result = base.СостОтгрузки;
        ...
        public override IIS.Itogovaya.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.Itogovaya.СостОплаты result = base.СостояниеОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостE", typeof(IIS.Itogovaya.ЗаказПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостL", typeof(IIS.Itogovaya.ЗаказПост));
                }
            }
        }
    }
