...
namespace IIS.Itogovaya
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya.Номенклатура fНоменклатура;
        
        private IIS.Itogovaya.ОтчетОЗак fОтчетОЗак;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Itogovaya.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Itogovaya.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itogovaya.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Itogovaya.ЗаказПост",
                "IIS.Itogovaya.ОтчетОЗак"})]
        public virtual IIS.Itogovaya.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.Itogovaya.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Itogovaya.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itogovaya.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Itogovaya.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Itogovaya.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.Itogovaya.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Itogovaya.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itogovaya.ТЧЗаказ dataobject)
        {
