    ...
    public class ЕдиницыИзмер : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмерE", typeof(IIS.Itogovaya.ЕдиницыИзмер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмерL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмерL", typeof(IIS.Itogovaya.ЕдиницыИзмер));
                }
            }
        }
    }
